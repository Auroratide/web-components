import{_ as r}from"../chunks/preload-helper.BQ24v_F8.js";import{s as h,n as m}from"../chunks/scheduler.Ce_0Mfso.js";import{S as g,i as u,s as d,e as j,m as b,l as f,d as l,h as w,c as q,a as z,n as _,w as y,f as c,o as v,p as k,q as T,r as $}from"../chunks/index.QmGHi4hh.js";import{R as A}from"../chunks/Readme.BbztUA8r.js";const I=`<h1 id="the-img-zoom-element">The img-zoom Element</h1>
...
`,x=""+new URL("../assets/fruit.DBcY37oa.png",import.meta.url).href,E=""+new URL("../assets/fruit.Ipb7VTQf.webp",import.meta.url).href;function R(o){let t,a,n,e;return n=new A({props:{html:I,assets:[{replace:"./fruit.png",with:x},{replace:"./fruit.webp",with:E}]}}),{c(){t=d(),a=j("div"),b(n.$$.fragment),this.h()},l(s){f("svelte-1lg55k8",document.head).forEach(l),t=w(s),a=q(s,"DIV",{class:!0});var i=z(a);_(n.$$.fragment,i),i.forEach(l),this.h()},h(){document.title="The img-zoom Element",y(a,"class","img-contained svelte-w5efvt")},m(s,p){c(s,t,p),c(s,a,p),v(n,a,null),e=!0},p:m,i(s){e||(k(n.$$.fragment,s),e=!0)},o(s){T(n.$$.fragment,s),e=!1},d(s){s&&(l(t),l(a)),$(n)}}}function C(o){return r(()=>import("../chunks/define.BRQghwY9.js"),__vite__mapDeps([]),import.meta.url),[]}class W extends g{constructor(t){super(),u(this,t,C,R,h,{})}}export{W as component};
