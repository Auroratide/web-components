import{_ as p}from"../chunks/preload-helper.BQ24v_F8.js";import{s as c,n as h,o as i}from"../chunks/scheduler.Ce_0Mfso.js";import{S as r,i as g,s as d,l as u,m as j,d as o,h as m,n as f,f as b,o as q,p as w,q as y,r as T}from"../chunks/index.DV7c2iXt.js";import{R as _}from"../chunks/Readme.RdwmlXsj.js";import{b as v}from"../chunks/build-tocs.2fh9akDk.js";const O=`<h1 id="the-table-of-contents-element">The table-of-contents Element</h1>
...
`;function k(l){let n,a,t;return a=new _({props:{html:O}}),{c(){n=d(),u(a.$$.fragment),this.h()},l(s){j("svelte-9u7l48",document.head).forEach(o),n=m(s),f(a.$$.fragment,s),this.h()},h(){document.title="The table-of-contents Element"},m(s,e){b(s,n,e),q(a,s,e),t=!0},p:h,i(s){t||(w(a.$$.fragment,s),t=!0)},o(s){y(a.$$.fragment,s),t=!1},d(s){s&&o(n),T(a,s)}}}function $(l){return p(()=>import("../chunks/define.CM3FkMQf.js"),__vite__mapDeps([]),import.meta.url),i(()=>{v()}),[]}class E extends r{constructor(n){super(),g(this,n,$,k,c,{})}}export{E as component};
