...
`,x=""+new URL("../assets/fruit.DBcY37oa.png",import.meta.url).href,E=""+new URL("../assets/fruit.Ipb7VTQf.webp",import.meta.url).href;function R(o){let t,a,n,e;return n=new A({props:{html:I,assets:[{replace:"./fruit.png",with:x},{replace:"./fruit.webp",with:E}]}}),{c(){t=d(),a=j("div"),f(n.$$.fragment),this.h()},l(s){b("svelte-1lg55k8",document.head).forEach(l),t=w(s),a=q(s,"DIV",{class:!0});var i=z(a);_(n.$$.fragment,i),i.forEach(l),this.h()},h(){document.title="The img-zoom Element",y(a,"class","img-contained svelte-w5efvt")},m(s,p){c(s,t,p),c(s,a,p),v(n,a,null),e=!0},p:m,i(s){e||(T(n.$$.fragment,s),e=!0)},o(s){k(n.$$.fragment,s),e=!1},d(s){s&&(l(t),l(a)),$(n)}}}function C(o){return r(()=>import("../chunks/define.BWqSeyDx.js"),__vite__mapDeps([]),import.meta.url),[]}class U extends g{constructor(t){super(),u(this,t,C,R,h,{})}}export{U as component};
