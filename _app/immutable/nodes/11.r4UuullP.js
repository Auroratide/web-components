const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../assets/style.B89jwdWn.css"])))=>i.map(i=>d[i]);
import{_ as p}from"../chunks/C1FmrZbK.js";import{s as c,n as r,o}from"../chunks/p4Z6_urL.js";import{S as i,i as d,a as h,t as u,b as g,m,g as j,n as y}from"../chunks/BJ0JgjBn.js";import{R as w}from"../chunks/s_ZfC1PQ.js";import{s as f}from"../chunks/DlallKuY.js";const b=`<h1 id="the-typewritten-text-element">The typewritten-text Element</h1>
...
<pre><code class="language-css">typewritten-<span class="hljs-selector-tag">text</span> {
...
<pre><code class="language-css">typewritten-<span class="hljs-selector-tag">text</span> <span class="hljs-selector-class">.cursor</span><span class="hljs-selector-class">.current</span><span class="hljs-selector-pseudo">::after</span> { }
</code></pre>
...
<pre><code class="language-css">typewritten-<span class="hljs-selector-tag">text</span> <span class="hljs-selector-class">.cursor</span><span class="hljs-selector-class">.current</span><span class="hljs-selector-pseudo">::after</span> {
	...
	<span class="hljs-attribute">inset-inline-end</span>: -<span class="hljs-number">1ch</span>;
}
</code></pre>
...
<span class="hljs-selector-class">.typewriter-cycle</span> <span class="hljs-selector-tag">li</span><span class="hljs-selector-pseudo">:not</span>(<span class="hljs-selector-pseudo">:first-child</span>) {
	<span class="hljs-attribute">position</span>: absolute;
	<span class="hljs-attribute">inset</span>: <span class="hljs-number">0</span>;
}

typewritten-<span class="hljs-selector-tag">text</span> { <span class="hljs-attribute">font-weight</span>: bold; }
typewritten-<span class="hljs-selector-tag">text</span><span class="hljs-selector-pseudo">:not</span>(<span class="hljs-selector-class">.active</span>) <span class="hljs-selector-class">.cursor</span><span class="hljs-selector-pseudo">::after</span> {
