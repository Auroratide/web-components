import{_ as l}from"../chunks/preload-helper.C1FmrZbK.js";import{s as p,n as o}from"../chunks/scheduler.uMbUtuGX.js";import{S as i,i as c,c as r,a as b,m as h,t as d,n as m,o as u}from"../chunks/index.Dz7ClLEz.js";import{R as g}from"../chunks/Readme.DVy4TuAV.js";const j=`<h1 id="the-tab-list-elements">The tab-list Elements</h1>
...
<pre><code class="language-css"><span class="hljs-selector-tag">div</span><span class="hljs-selector-class">.tab-container</span> {
	<span class="hljs-attribute">box-shadow</span>: <span class="hljs-number">0</span> <span class="hljs-number">0.125em</span> <span class="hljs-number">0.25em</span> <span class="hljs-built_in">oklch</span>(<span class="hljs-number">0%</span> <span class="hljs-number">0</span> <span class="hljs-number">0</span> / <span class="hljs-number">0.25</span>);
}

tab-list {
	<span class="hljs-attribute">background</span>: <span class="hljs-built_in">oklch</span>(<span class="hljs-number">55%</span> <span class="hljs-number">0.119</span> <span class="hljs-number">250</span>);
...
tab-item {
	...
	<span class="hljs-attribute">background</span>: <span class="hljs-built_in">oklch</span>(<span class="hljs-number">55%</span> <span class="hljs-number">0.119</span> <span class="hljs-number">250</span>);
	<span class="hljs-attribute">color</span>: <span class="hljs-built_in">oklch</span>(<span class="hljs-number">97.5%</span> <span class="hljs-number">0.005</span> <span class="hljs-number">255</span>);
	<span class="hljs-attribute">padding</span>: <span class="hljs-number">0.625em</span> <span class="hljs-number">1.125em</span>;
	<span class="hljs-attribute">border-right</span>: <span class="hljs-number">0.125em</span> solid <span class="hljs-built_in">oklch</span>(<span class="hljs-number">38%</span> <span class="hljs-number">0.125</span> <span class="hljs-number">250</span>);
}
...
tab-item<span class="hljs-selector-pseudo">:focus</span><span class="hljs-selector-pseudo">:not</span>(<span class="hljs-selector-attr">[selected]</span>) {
	<span class="hljs-attribute">background</span>: <span class="hljs-built_in">oklch</span>(<span class="hljs-number">38%</span> <span class="hljs-number">0.125</span> <span class="hljs-number">250</span>);
}
...
tab-item<span class="hljs-selector-attr">[selected]</span> {
	...
	<span class="hljs-attribute">color</span>: <span class="hljs-built_in">oklch</span>(<span class="hljs-number">80%</span> <span class="hljs-number">0.005</span> <span class="hljs-number">255</span>);
}
...
tab-panel {
	...
	<span class="hljs-attribute">border</span>: none;
	<span class="hljs-attribute">padding</span>: <span class="hljs-number">0.625em</span> <span class="hljs-number">1.125em</span> <span class="hljs-number">1.125em</span>;
