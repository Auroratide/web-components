...
`;function w(t){let s,n;return s=new f({props:{html:q}}),{c(){r(s.$$.fragment)},l(a){g(s.$$.fragment,a)},m(a,e){d(s,a,e),n=!0},p,i(a){n||(u(s.$$.fragment,a),n=!0)},o(a){j(s.$$.fragment,a),n=!1},d(a){m(s,a)}}}function y(t){return l(()=>import("../chunks/define.gp_6CtRi.js"),[],import.meta.url),c(()=>{b()}),[]}class $ extends i{constructor(s){super(),h(this,s,y,w,o,{})}}export{$ as component};
