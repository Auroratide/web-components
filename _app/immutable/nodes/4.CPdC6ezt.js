...
`;function _(o){let s,n,e;return n=new q({props:{html:S}}),{c(){s=u(),f(n.$$.fragment),this.h()},l(t){m("svelte-8ek0hh",document.head).forEach(l),s=g(t),b(n.$$.fragment,t),this.h()},h(){document.title="The flip-card Element"},m(t,a){j(t,s,a),y(n,t,a),e=!0},p:r,i(t){e||(w(n.$$.fragment,t),e=!0)},o(t){v(n.$$.fragment,t),e=!1},d(t){t&&l(s),k(n,t)}}}function F(o){return i(()=>import("../chunks/define.Bj-Sr4zv.js"),__vite__mapDeps([]),import.meta.url),p(()=>{T()}),[]}class E extends d{constructor(s){super(),h(this,s,F,_,c,{})}}export{E as component};
