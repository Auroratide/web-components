import{_ as r}from"../chunks/preload-helper.BQ24v_F8.js";import{s as h,n as m}from"../chunks/scheduler.Ce_0Mfso.js";import{S as g,i as u,s as d,e as j,l as f,m as b,d as l,h as w,c as q,a as z,n as _,w as y,f as c,o as v,p as T,q as k,r as $}from"../chunks/index.DV7c2iXt.js";import{R as A}from"../chunks/Readme.RdwmlXsj.js";import{f as I}from"../chunks/fruit.BMJTztQG.js";const x=`<h1 id="the-img-zoom-element">The img-zoom Element</h1>
...
`,E=""+new URL("../assets/fruit.Ipb7VTQf.webp",import.meta.url).href;function R(o){let t,a,n,e;return n=new A({props:{html:x,assets:[{replace:"./fruit.png",with:I},{replace:"./fruit.webp",with:E}]}}),{c(){t=d(),a=j("div"),f(n.$$.fragment),this.h()},l(s){b("svelte-1lg55k8",document.head).forEach(l),t=w(s),a=q(s,"DIV",{class:!0});var i=z(a);_(n.$$.fragment,i),i.forEach(l),this.h()},h(){document.title="The img-zoom Element",y(a,"class","img-contained svelte-w5efvt")},m(s,p){c(s,t,p),c(s,a,p),v(n,a,null),e=!0},p:m,i(s){e||(T(n.$$.fragment,s),e=!0)},o(s){k(n.$$.fragment,s),e=!1},d(s){s&&(l(t),l(a)),$(n)}}}function C(o){return r(()=>import("../chunks/define.A-dZRAgB.js"),__vite__mapDeps([]),import.meta.url),[]}class P extends g{constructor(t){super(),u(this,t,C,R,h,{})}}export{P as component};
