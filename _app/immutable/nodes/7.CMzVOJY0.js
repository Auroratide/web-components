import{_ as p}from"../chunks/preload-helper.BQ24v_F8.js";import{s as r,n as o,o as i}from"../chunks/scheduler.Ce_0Mfso.js";import{S as d,i as h,s as u,m as g,l as m,d as c,h as j,n as y,f as w,o as f,p as b,q as x,r as v}from"../chunks/index.QmGHi4hh.js";import{R as q}from"../chunks/Readme.BbztUA8r.js";import{s as T}from"../chunks/setup-cycle-demo.DlallKuY.js";const k=`<h1 id="the-typewritten-text-element">The typewritten-text Element</h1>
...
`,_=""+new URL("../assets/demo.BbQyX9Y4.gif",import.meta.url).href,S=()=>{document.querySelectorAll("wc-demo").forEach(t=>{const s=t.querySelector(".run"),e=t.querySelectorAll("typewritten-text");e.forEach(a=>{a.addEventListener("paused",()=>{(s==null?void 0:s.textContent)==="Pause"&&(s.textContent="Run")}),a.addEventListener("typed",()=>{a.classList.add("typed")}),a.addEventListener("resumed",()=>{a.classList.remove("typed")})});const l=()=>{e.forEach(a=>a.resume())},n=()=>{e.forEach(a=>a.pause())};s==null||s.addEventListener("click",()=>{(s==null?void 0:s.textContent)==="Run"?(s.textContent="Pause",l()):(s.textContent="Run",n())})})},E=()=>{const t=document.querySelector("#janet typewritten-text"),s=document.querySelector("#dinesh typewritten-text"),e=document.querySelector("#dialog-demo .rerun");let l=0;t==null||t.addEventListener("typed",()=>{l=setTimeout(()=>s==null?void 0:s.type(),s==null?void 0:s.repeatInterval)}),e==null||e.addEventListener("click",()=>{clearTimeout(l),s==null||s.pause(),t==null||t.reset(),s==null||s.reset(),t==null||t.type()})};function C(t){let s,e,l;return e=new q({props:{html:k,assets:[{replace:"./demo.gif",with:_}]}}),{c(){s=u(),g(e.$$.fragment),this.h()},l(n){m("svelte-i80zog",document.head).forEach(c),s=j(n),y(e.$$.fragment,n),this.h()},h(){document.title="The typewritten-text Element"},m(n,a){w(n,s,a),f(e,n,a),l=!0},p:o,i(n){l||(b(e.$$.fragment,n),l=!0)},o(n){x(e.$$.fragment,n),l=!1},d(n){n&&c(s),v(e,n)}}}function A(t){return p(()=>Promise.resolve({}),__vite__mapDeps([0]),import.meta.url),p(()=>import("../chunks/define.BFzeFfcw.js"),__vite__mapDeps([]),import.meta.url),i(()=>{S(),T(),E()}),[]}class R extends d{constructor(s){super(),h(this,s,A,C,r,{})}}export{R as component};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["../assets/style.DZNs7oul.css"]
  }
