...
`;function y(p){let s,n;return{c(){s=m(),n=b("article"),this.h()},l(a){d('[data-svelte="svelte-ueg07q"]',document.head).forEach(t),s=u(a),n=j(a,"ARTICLE",{});var r=w(n);r.forEach(t),this.h()},h(){document.title="Web Components by Auroratide"},m(a,e){o(a,s,e),o(a,n,e),n.innerHTML=f},p:l,i:l,o:l,d(a){a&&t(s),a&&t(n)}}}function v(p){return i(()=>import("../../chunks/define-f934d0c8.js"),[],import.meta.url),i(()=>import("../../chunks/define-7e898c82.js"),["../../chunks/define-7e898c82.js","../../chunks/events-19830ba9.js"],import.meta.url),[]}class q extends c{constructor(s){super(),h(this,s,v,y,g,{})}}export{q as default};
